...
<head>
  <title>ChatBot</title>
        ...
        <link rel="icon" type="image/png" href="img/tce.png">
...
<body>
    ...
    <a href="Course.html" target="_blank"><b>Course Comparison</b></a>
    <a href="placement.html" target="_blank"><b>Placement Comparison</b></a>
...
<div class="chat">
<a style="text-decoration:none;" href="#"><div id="sc"><center><img style="float:left;" src="img/tce.png" width="20px" height="20px"/><b>Chat With US</b></center></div></a>
<div id="panel">
...
$(document).ready(function(){
    ...
    $("#sc").click(function(){
          ...
          if(i==1)
          {
              $('#div').html("<div class=\"ou\"> Hello Guest. Welcome To TCE Chat</div><br>");
