     ...
     <?php
       ...
       function make_links_clickable($text){
        ...
        if($flag==0)
        {
        	 ...
        	 $output="Sorry I have no knowledge of ".$msgg." yet. Type only one keyword without space instead of full sentence. For Emergency Help Call: 01757687942 Or https://www.tce.edu/";
        	 $result = make_links_clickable($output);
        	 echo "$result";
